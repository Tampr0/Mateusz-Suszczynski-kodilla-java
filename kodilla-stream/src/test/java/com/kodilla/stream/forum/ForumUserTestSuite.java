...
public class ForumUserTestSuite {
    ...
    public void testGetLocationsOffFriends() {
        ...
        //Then
        Assert.assertEquals(3, user1.getLocationOffFriends().size());
        Assert.assertTrue(user1.getLocationOffFriends().contains("Key West"));
        Assert.assertTrue(user1.getLocationOffFriends().contains("Washington"));
        Assert.assertTrue(user1.getLocationOffFriends().contains("Miami"));
        Assert.assertFalse(user1.getLocationOffFriends().contains("Orlando"));
    }
