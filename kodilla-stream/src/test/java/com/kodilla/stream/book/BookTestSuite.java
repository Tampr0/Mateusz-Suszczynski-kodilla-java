...
public class BookTestSuite {
    ...
    public void testGetListUsingIntStream() {
        ...
        //Then
        long nuberOfBooksPublicatedAfter2007 = IntStream.range(0,books.size())
                .filter(n -> books.get(n).getYearOfPublication() > 2007)
                //.map(n -> 1)
                .count();
        System.out.println(nuberOfBooksPublicatedAfter2007);
        Assert.assertEquals(3, nuberOfBooksPublicatedAfter2007);
